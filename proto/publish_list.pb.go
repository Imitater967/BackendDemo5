...
type DouyinPublishListRequest struct {
	...
	UserId *int64  `protobuf:"varint,1,req,name=user_id,json=userId" json:"user_id,omitempty" form:"user_id"` // 用户id
...
func (x *DouyinPublishListRequest) Reset() {
	*x = DouyinPublishListRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_publish_list_proto_msgTypes[0]
...
func (*DouyinPublishListRequest) Descriptor() ([]byte, []int) {
	return file_publish_list_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinPublishListResponse) Reset() {
	*x = DouyinPublishListResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_publish_list_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinPublishListResponse) Descriptor() ([]byte, []int) {
	return file_publish_list_proto_rawDescGZIP(), []int{1}
}
...
var File_publish_list_proto protoreflect.FileDescriptor

var file_publish_list_proto_rawDesc = []byte{
	0x0a, 0x12, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x73, 0x68, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x2e, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x12, 0x0b, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x63, 0x6f, 0x72,
	0x65, 0x1a, 0x0a, 0x66, 0x65, 0x65, 0x64, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x4c, 0x0a,
	...
	0x20, 0x02, 0x28, 0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x91, 0x01, 0x0a, 0x1c,
	...
	0x09, 0x52, 0x09, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x4d, 0x73, 0x67, 0x12, 0x31, 0x0a, 0x0a,
	0x76, 0x69, 0x64, 0x65, 0x6f, 0x5f, 0x6c, 0x69, 0x73, 0x74, 0x18, 0x03, 0x20, 0x03, 0x28, 0x0b,
	0x32, 0x12, 0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x2e, 0x56,
...
var (
	file_publish_list_proto_rawDescOnce sync.Once
	file_publish_list_proto_rawDescData = file_publish_list_proto_rawDesc
)

func file_publish_list_proto_rawDescGZIP() []byte {
	file_publish_list_proto_rawDescOnce.Do(func() {
		file_publish_list_proto_rawDescData = protoimpl.X.CompressGZIP(file_publish_list_proto_rawDescData)
	})
	return file_publish_list_proto_rawDescData
}

var file_publish_list_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
func init() { file_publish_list_proto_init() }
func file_publish_list_proto_init() {
	if File_publish_list_proto != nil {
		return
	}
	file_feed_proto_init()
	if !protoimpl.UnsafeEnabled {
		file_publish_list_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_publish_list_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_publish_list_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_publish_list_proto_goTypes,
		DependencyIndexes: file_publish_list_proto_depIdxs,
		MessageInfos:      file_publish_list_proto_msgTypes,
	}.Build()
	File_publish_list_proto = out.File
	file_publish_list_proto_rawDesc = nil
	file_publish_list_proto_goTypes = nil
	file_publish_list_proto_depIdxs = nil
}
