...
func (x *Video) Reset() {
	*x = Video{}
	if protoimpl.UnsafeEnabled {
		mi := &file_favorite_list_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Video) Descriptor() ([]byte, []int) {
	return file_favorite_list_proto_rawDescGZIP(), []int{2}
}
...
func (x *User) Reset() {
	*x = User{}
	if protoimpl.UnsafeEnabled {
		mi := &file_favorite_list_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*User) Descriptor() ([]byte, []int) {
	return file_favorite_list_proto_rawDescGZIP(), []int{3}
}
...
var file_favorite_list_proto_rawDesc = []byte{
	...
	0x74, 0x72, 0x61, 0x2e, 0x66, 0x69, 0x72, 0x73, 0x74, 0x22, 0x4d, 0x0a, 0x1c, 0x64, 0x6f, 0x75,
	...
	0x09, 0x52, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x22, 0x99, 0x01, 0x0a, 0x1d, 0x64, 0x6f, 0x75,
	0x79, 0x69, 0x6e, 0x5f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x5f, 0x6c, 0x69, 0x73,
	...
	0x0a, 0x02, 0x69, 0x64, 0x18, 0x01, 0x20, 0x02, 0x28, 0x03, 0x52, 0x02, 0x69, 0x64, 0x12, 0x30,
	0x0a, 0x06, 0x61, 0x75, 0x74, 0x68, 0x6f, 0x72, 0x18, 0x02, 0x20, 0x02, 0x28, 0x0b, 0x32, 0x18,
	0x2e, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x65, 0x78, 0x74, 0x72, 0x61, 0x2e, 0x66, 0x69,
...
var file_favorite_list_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_favorite_list_proto_goTypes = []interface{}{
	(*DouyinFavoriteListRequest)(nil),  // 0: douyin.extra.first.douyin_favorite_list_request
	(*DouyinFavoriteListResponse)(nil), // 1: douyin.extra.first.douyin_favorite_list_response
	(*Video)(nil),                      // 2: douyin.extra.first.Video
	(*User)(nil),                       // 3: douyin.extra.first.User
}
var file_favorite_list_proto_depIdxs = []int32{
	2, // 0: douyin.extra.first.douyin_favorite_list_response.video_list:type_name -> douyin.extra.first.Video
	3, // 1: douyin.extra.first.Video.author:type_name -> douyin.extra.first.User
...
func file_favorite_list_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_favorite_list_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Video); i {
			case 0:
				return &v.state
			case 1:
		...
		file_favorite_list_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*User); i {
			case 0:
				return &v.state
			case 1:
