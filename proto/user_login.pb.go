...
type DouyinUserLoginRequest struct {
	...
	Username *string `form:"username" protobuf:"bytes,1,req,name=username" json:"username,omitempty" form:"username" binding:"required"` // 登录用户名
	Password *string `form:"password" protobuf:"bytes,2,req,name=password" json:"password,omitempty" form:"password" binding:"required"` // 登录密码
}
...
var file_user_login_proto_rawDesc = []byte{
	...
	0x74, 0x6f, 0x12, 0x0b, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e, 0x63, 0x6f, 0x72, 0x65, 0x22,
	...
	0x65, 0x6e, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
}
