...
func (x *DouyinFavoriteActionRequest) Reset() {
	*x = DouyinFavoriteActionRequest{}
	if protoimpl.UnsafeEnabled {
		mi := &file_favorite_action_proto_msgTypes[0]
...
func (*DouyinFavoriteActionRequest) Descriptor() ([]byte, []int) {
	return file_favorite_action_proto_rawDescGZIP(), []int{0}
}
...
func (x *DouyinFavoriteActionResponse) Reset() {
	*x = DouyinFavoriteActionResponse{}
	if protoimpl.UnsafeEnabled {
		mi := &file_favorite_action_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*DouyinFavoriteActionResponse) Descriptor() ([]byte, []int) {
	return file_favorite_action_proto_rawDescGZIP(), []int{1}
}
...
var File_favorite_action_proto protoreflect.FileDescriptor

var file_favorite_action_proto_rawDesc = []byte{
	0x0a, 0x15, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69, 0x74, 0x65, 0x5f, 0x61, 0x63, 0x74, 0x69, 0x6f,
	0x6e, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x12, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x2e,
	0x65, 0x78, 0x74, 0x72, 0x61, 0x2e, 0x66, 0x69, 0x72, 0x73, 0x74, 0x22, 0x72, 0x0a, 0x1e, 0x64,
	...
	0x02, 0x20, 0x02, 0x28, 0x03, 0x52, 0x07, 0x76, 0x69, 0x64, 0x65, 0x6f, 0x49, 0x64, 0x12, 0x1f,
	0x0a, 0x0b, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x03, 0x20,
	0x02, 0x28, 0x05, 0x52, 0x0a, 0x61, 0x63, 0x74, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70, 0x65, 0x22,
	0x61, 0x0a, 0x1f, 0x64, 0x6f, 0x75, 0x79, 0x69, 0x6e, 0x5f, 0x66, 0x61, 0x76, 0x6f, 0x72, 0x69,
	...
	0x73, 0x67, 0x42, 0x09, 0x5a, 0x07, 0x2e, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f,
}

var (
	file_favorite_action_proto_rawDescOnce sync.Once
	file_favorite_action_proto_rawDescData = file_favorite_action_proto_rawDesc
)

func file_favorite_action_proto_rawDescGZIP() []byte {
	file_favorite_action_proto_rawDescOnce.Do(func() {
		file_favorite_action_proto_rawDescData = protoimpl.X.CompressGZIP(file_favorite_action_proto_rawDescData)
	})
	return file_favorite_action_proto_rawDescData
}

var file_favorite_action_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_favorite_action_proto_goTypes = []interface{}{
...
var file_favorite_action_proto_depIdxs = []int32{
...
func init() { file_favorite_action_proto_init() }
func file_favorite_action_proto_init() {
	if File_favorite_action_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_favorite_action_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_favorite_action_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_favorite_action_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_favorite_action_proto_goTypes,
		DependencyIndexes: file_favorite_action_proto_depIdxs,
		MessageInfos:      file_favorite_action_proto_msgTypes,
	}.Build()
	File_favorite_action_proto = out.File
	file_favorite_action_proto_rawDesc = nil
	file_favorite_action_proto_goTypes = nil
	file_favorite_action_proto_depIdxs = nil
}
